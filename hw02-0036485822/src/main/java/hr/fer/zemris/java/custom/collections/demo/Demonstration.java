...
/**
 * Class used to demonstrate that ArrayIndexedCollection and
 * LinkedListIndexedCollection classes work as expected.
 * 
 * @author tin
 *
 */
public class Demonstration {
  ...
  public static void main(String[] args) {
    ...
    col.add("Los Angeles");
    final LinkedListIndexedCollection col2 = new LinkedListIndexedCollection(col);
